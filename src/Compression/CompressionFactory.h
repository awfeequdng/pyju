...
{
protected:
    using Creator = std::function<CompressionCodecPtr(const Strings & parameters)>;
    using CreatorWithType = std::function<CompressionCodecPtr(const Strings & parameters, const String &type)>;
...
public:
    ...
    CompressionCodecPtr get(const std::unordered_map<String, Strings> & parameters, const String & data_type, CompressionCodecPtr current_default = nullptr, bool only_generic = false) const;
...
protected:
    CompressionCodecPtr getImpl(const String & family_name, const Strings & arguments, const String & data_type) const;
