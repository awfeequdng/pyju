...
public:
    ...
    virtual String getCodecDesc() const;

    /// Codec description with "CODEC" prefix, for example "CODEC(ZSTD(2))" or
    /// "CODEC(LZ4,LZ4HC(5))"
    Strings getFullCodecDesc() const;
...
protected:
    ...
    void setCodecDescription(const String & name, const Strings & arguments = {});

private:
    String  codec_desc;
    Strings full_codec_desc;
};
