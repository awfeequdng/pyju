...
class AstNode {
 public:
  ...
  auto source_loc() const -> PYJU::SourceLocation { return source_loc_; }
 ...
 protected:
  ...
  // constructed.
  explicit AstNode(AstNodeKind kind, PYJU::SourceLocation source_loc)
 ...
 private:
  AstNodeKind kind_;
  PYJU::SourceLocation source_loc_;
};
