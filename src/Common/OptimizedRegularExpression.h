...
private:
    ...
    std::optional<PYJU::StringSearcher<true, true>> case_sensitive_substring_searcher;
    std::optional<PYJU::StringSearcher<false, true>> case_insensitive_substring_searcher;
