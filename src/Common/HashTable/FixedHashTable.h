...
public:
    ...
    {
    public:
        Reader(PYJU::ReadBuffer & in_) : in(in_) {}
...
public:
    ...
    void read(PYJU::ReadBuffer & rb)
    {
        ...
        for (size_t i = 0; i < m_size; ++i)
        {
            ...
            PYJU::readVarUInt(place_value, rb);
            Cell x;
            x.read(rb);
