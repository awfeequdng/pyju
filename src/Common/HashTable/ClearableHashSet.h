...
struct ClearableHashSetState
{
    ...
    void write(PYJU::WriteBuffer & wb) const         { PYJU::writeBinary(version, wb); }
    void writeText(PYJU::WriteBuffer & wb) const     { PYJU::writeText(version, wb); }

    /// Deserialization, in binary and text form.
    void read(PYJU::ReadBuffer & rb)                 { PYJU::readBinary(version, rb); }
    void readText(PYJU::ReadBuffer & rb)             { PYJU::readText(version, rb); }
};
