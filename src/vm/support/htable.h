...
#ifndef PYJU_HTABLE_H
#define PYJU_HTABLE_H
...
htable_t *htable_new(htable_t *h, size_t size) PYJU_NOTSAFEPOINT;
...
void *HTNAME##_get(htable_t *h, void *key) PYJU_NOTSAFEPOINT;             \
void HTNAME##_put(htable_t *h, void *key, void *val) PYJU_NOTSAFEPOINT;   \
void HTNAME##_adjoin(htable_t *h, void *key, void *val) PYJU_NOTSAFEPOINT;\
int HTNAME##_has(htable_t *h, void *key) PYJU_NOTSAFEPOINT;               \
int HTNAME##_remove(htable_t *h, void *key) PYJU_NOTSAFEPOINT;            \
void **HTNAME##_bp(htable_t *h, void *key) PYJU_NOTSAFEPOINT;
