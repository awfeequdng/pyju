...
#ifndef PYJU_PLATFORM_H
#define PYJU_PLATFORM_H
...
#undef PYJU_NO_ASAN
#define PYJU_NO_ASAN __attribute__((no_sanitize("address")))
#endif
#if __has_feature(memory_sanitizer)
#define _COMPILER_MSAN_ENABLED_
#undef PYJU_NO_MSAN
#define PYJU_NO_MSAN __attribute__((no_sanitize("mempry")))
#endif
...
#undef PYJU_NO_TSAN
#define PYJU_NO_TSAN __attribute__((no_sanitize("thread")))
#endif
#else // GCC flavor
...
#endif
#endif // __has_feature
#define PYJU_NO_SANITIZE PYJU_NO_ASAN PYJU_NO_MSAN PYJU_NO_TSAN
