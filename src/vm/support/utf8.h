...
PYJU_DLLEXPORT size_t u8_offset(const char *str, size_t charnum);

/* byte offset to character number */
PYJU_DLLEXPORT size_t u8_charnum(const char *str, size_t offset);

/* return next character, updating an index variable */
uint32_t u8_nextchar(const char *s, size_t *i) PYJU_NOTSAFEPOINT;
...
PYJU_DLLEXPORT size_t u8_strwidth(const char *s);
...
PYJU_DLLEXPORT int u8_isvalid(const char *str, size_t length);
